...
privileged aspect ShowingServiceImpl_Roo_Service_Impl {
     ...
     * @return Page
     */
    public Page<Showing> ShowingServiceImpl.findByTicket(Ticket ticket, GlobalSearch globalSearch, Pageable pageable) {
        return getShowingRepository().findByTicket(ticket, globalSearch, pageable);
    }
     ...
     * @return Long
     */
    public long ShowingServiceImpl.countByTicket(Ticket ticket) {
        return getShowingRepository().countByTicket(ticket);
    }
