...
privileged aspect ShowingsCollectionJsonController_Roo_JSON {
    ...
    declare @type: ShowingsCollectionJsonController: @RequestMapping(value = "/showings", name = "ShowingsCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
